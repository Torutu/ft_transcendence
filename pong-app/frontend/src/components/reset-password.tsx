...
//     } else {
//       // Success case - would normally send reset link
//       setIsSubmitted(true);
//       setError('');
//     }
//   };
...
//                 className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:caret-blue-500 placeholder-gray-400"
//                 value={email}
//                 onChange={(e) => {
