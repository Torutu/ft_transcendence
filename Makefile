...
# help:  ## Show grouped help for available commands
# 	@echo ""
# 	@echo "Available commands:"
# 	@echo ""
# 	@echo "Build & Run Commands:"
# 	@awk 'BEGIN {FS = ":.*?## "} /^run:|^start:|^up:|^build:/ {printf "  \033[36m%-15s\033[0m %s\n", $$1, $$2}' $(MAKEFILE_LIST)
# 	@echo ""
# 	@echo "Clean Commands:"
# 	@awk 'BEGIN {FS = ":.*?## "} /^down:|^stop:|^clean:|^fclean:|^re:/ {printf "  \033[36m%-15s\033[0m %s\n", $$1, $$2}' $(MAKEFILE_LIST)
# 	@echo ""
# 	@echo "Utility Commands:"
# 	@awk 'BEGIN {FS = ":.*?## "} /^status:|^logs:|^help:|^all:/ {printf "  \033[36m%-15s\033[0m %s\n", $$1, $$2}' $(MAKEFILE_LIST)

# Declare all phony targets to avoid filename conflicts
